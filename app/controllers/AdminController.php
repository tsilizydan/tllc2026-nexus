...
class AdminController extends Controller {
    ...
    public function dashboard(): void {
        ...
        $stats = [
            ...
            'subscribers' => (new NewsletterSubscriber())->activeCount(),
        ];
    ...
    public function messages(): void {
        ...
        $this->view('admin.messages', ['pageTitle' => 'Messages', 'messages' => $messages]);
    }

    public function markMessageRead(string $id): void {
        $this->requireAuth();
        $this->requireAdmin();
        if (!$this->validateCsrf()) { $this->redirect('/admin/messages'); return; }
        (new ContactMessage())->markRead((int)$id);
        $this->flash('success', 'Marqué comme lu.');
    ...
    public function newsletter(): void {
        ...
        $this->view('admin.newsletter', ['pageTitle' => 'Newsletter', 'subscribers' => $subscribers]);
    }

    public function deleteSubscriber(string $id): void {
        $this->requireAuth();
        $this->requireAdmin();
        if (!$this->validateCsrf()) { $this->redirect('/admin/newsletter'); return; }
        (new NewsletterSubscriber())->delete((int)$id);
