...
class AgendaController extends Controller {
    ...
    public function store(): void {
        ...
        $this->flash('success', 'Événement créé.'); Notification::notify(Auth::id(), 'agenda', 'Événement créé', '"' . $this->input('title') . '" a été ajouté à l\'agenda.', url('/agenda'), 'calendar-alt'); $this->redirect('/agenda');
    }
