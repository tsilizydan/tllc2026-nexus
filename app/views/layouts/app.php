<!DOCTYPE html>
<html lang="fr" x-data="appState()" :class="{ 'dark': darkMode }">
<head>
    <meta charset="UTF-8">
            ...
            <header class="topbar sticky top-0 z-20 flex items-center justify-between px-6 py-3">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="relative w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white transition-all hover:bg-white/10">
