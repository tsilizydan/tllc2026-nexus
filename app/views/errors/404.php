...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 7rem; font-weight: 800; background: linear-gradient(135deg, #6C3CE1, #22D3EE); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
...
<body>
    <div>
        ...
        <p class="desc">La page que vous recherchez n'existe pas ou a été déplacée.</p>
