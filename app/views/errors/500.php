...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 7rem; font-weight: 800; background: linear-gradient(135deg, #EF4444, #F59E0B); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
...
<body>
    <div>
        ...
        <h1 class="title">Erreur interne</h1>
        <p class="desc">Une erreur inattendue s'est produite. Veuillez réessayer ultérieurement.</p>
